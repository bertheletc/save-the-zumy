...
class stream
{
    ...
    public static final int ROS_LISTEN_PORT = 49389;
    ...
    {   
        ...
        InetAddress sensorAddress = InetAddress.getByName("192.168.1.102"); /*Device IP - May Change*/
        int numSamples = 0;
    ...
    {   
        ...
        synchronized (m_bufferedWriterSynchroLock)        {
            ...
            ServerSocket listen_socket = new ServerSocket(ROS_LISTEN_PORT);
            Socket listen_connection  = listen_socket.accept();
            listen_socket.close();
            OutputStream listen_output_stream = listen_connection.getOutputStream();
            m_bufferedWriter = new BufferedWriter(new OutputStreamWriter(listen_output_stream, "US-ASCII"));

            System.out.println("Connected, streaming data");
